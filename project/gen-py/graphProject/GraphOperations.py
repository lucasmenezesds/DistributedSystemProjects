...
class Processor(Iface, TProcessor):
    ...
    def process_readVertex(self, seqid, iprot, oprot):
        ...
        try:
            ...
            raise
        except CouldNotFindObject as objectNotFound:
            msg_type = TMessageType.REPLY
...
class readVertex_result(object):
    ...
    thrift_spec = (
        ...
        (1, TType.STRUCT, 'objectNotFound', (CouldNotFindObject, CouldNotFindObject.thrift_spec), None, ),  # 1
        (2, TType.STRUCT, 'opFailedMsg', (OperationHasFailed, OperationHasFailed.thrift_spec), None, ),  # 2
    )

    def __init__(self, success=None, objectNotFound=None, opFailedMsg=None,):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                ...
                if ftype == TType.STRUCT:
                    self.objectNotFound = CouldNotFindObject()
    ...
    def write(self, oprot):
        ...
        if self.objectNotFound is not None:
            oprot.writeFieldBegin('objectNotFound', TType.STRUCT, 1)
...
class updateVertex_result(object):
    ...
    def __init__(self, objectNotFound=None, opFailedMsg=None, invalidObjMsg=None,):
        self.objectNotFound = objectNotFound
        self.opFailedMsg = opFailedMsg
        self.invalidObjMsg = invalidObjMsg
